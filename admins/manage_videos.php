...
<head>
    ...
    <style>
        ...
        /* Removed custom .content class, using global .main-content */
    </style>
</head>
<body class="bg-light">
...
<div class="main-content">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <button class="btn btn-maroon" data-bs-toggle="modal" data-bs-target="#addVideoModal">
                <i class="fas fa-plus me-1"></i> Add Video
            </button>
        </div>
        <div class="text-muted small">Total videos: <?php echo count($videos); ?></div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button class="btn btn-sm btn-outline-info me-2" onclick="openEditModal(<?php echo htmlspecialchars(json_encode($row)); ?>)">
        ...
        <div class="modal-content">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="add_video" class="btn btn-maroon">Publish</button>
                </div>
            </form>
        </div>
    </div>
