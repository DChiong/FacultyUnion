        ...
        <div class="card shadow-sm">
            ...
            <table class="table table-hover table-striped mb-0 align-middle text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="width: 84px;">
                            <?php $photoSrc = (!empty($o['profile_picture']) && file_exists(__DIR__ . '/../' . $o['profile_picture'])) ? '../' . $o['profile_picture'] : '../images/facultyunion.png'; ?>
                        ...
                        <td class="text-nowrap">
                            ...
                            <a href="?delete=<?php echo $o['id']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Delete this officer?')"><i class="fas fa-trash"></i> Delete</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
